     ...
     <!-- Contenu de la modal -->
	  ...
	  <section class="centre-accueil">
	   ...
	   <div class="div_profil">
	          ...
	          <button class="profil_modify_btn" onclick="modifier_photo_profil();" id="modify_btn" style="display: none;">Modifier </button>
	    ...
	    if (isset($_POST['sumbit_profil_btn'])) {
            ...
            echo '<script> alert("'.$name_suite.'");</script>';
             $rename->closeCursor();
             ...
             $new_name = NULL;
             if (strstr($image_name, 'utilisateur')) {
               $nombre_mvisiteur++;
             ...
             {
                $chemin_temporaire = 'profil_tmp/'.$nombre_mvisiteur.'.'.$extension;
                echo '<script>alert('.$chemin_temporaire.'y0)</script>';
             ...
             // test du format de la source
              ...
              echo '<script>document.getElementById("profil_image").src = '.$new_name.';</script>';
