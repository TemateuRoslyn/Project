...
<!--             <li><a href=""><img src="Ressources/whatsapp.png" class="icone-whatsapp"></a></li>
 -->
        ...
        <section class="centre-accueil">
             ...
             <form method="post"action="fonctions/tritement-passe.php" class="nouscontacter" id="idFormulairePassModify" style="display: none;">
              
                 <!--*************************Les informations de l'utilisateur******************************-->
             
              <label>Tapez votre mot de passe:</label>  <input type="password" name="passe" size="50" placeholder="Tapez votre Adresse mail ici..." required id="passe">
