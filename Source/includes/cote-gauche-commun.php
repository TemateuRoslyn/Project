  ...
  <div class="menu-gauche">
          <div class="ex-menu-gauche">
            <aside class="aside">
                 ...
                 <div><a href="Projet-web.php">ACCUEIL</a></div>
                 <div><a href="faq.php">FAQ</a></div>
                 <div><a href="contact.php">CONTACT</a></div>
           </aside>
           <aside class="aside1">
                <div class="titles">M&eacute;dias</div>
                <div><a href="faculte-des-sciences.php">DOWNLOAD</a></div>
                <!-- <div><a href="licence.php">LICENCIE</a></div> -->
                <div><a href="logiciel.php">LOGICIELS</a></div>
           </aside>
           <aside class="aside2">
                <div class="titles">&Eacute;changes</div>
                <div><a href="chat.php">CHAT</a></div>
                <div><a href="partenariat.php">PARTENARIAT</a></div>
           </aside>
